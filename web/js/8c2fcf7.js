...
Ext.onReady(function() {
    ...
    symfony("get", "logged", "user", {}, function(response)
    {
    	...
    	switch(_workspace)
    	{
    		...
    		case 'administration':
    		{
    			itemsViewport.push(workspace.writepanel.getAdministrationMenu());
    			itemsViewport.push(workspace.writepanel.getAdministrationPanel());
    		...
    		case 'draw':
    		{
    			itemsViewport.push(workspace.writepanel.getDrawMenu());
    			itemsViewport.push(workspace.writepanel.getDrawPanel());
    		...
    		case 'paint':
    		{
    			itemsViewport.push(workspace.writepanel.getPaintMenu());
    			itemsViewport.push(workspace.writepanel.getPaintPanel());
    		...
    		case 'presentation':
    		{
    			itemsViewport.push(workspace.writepanel.getPresentationMenu());
    			itemsViewport.push(workspace.writepanel.getPresentationPanel());
    		...
    		case 'project':
    		{
    			itemsViewport.push(workspace.writepanel.getProjectMenu());
    			itemsViewport.push(workspace.writepanel.getProjectPanel());
    		...
    		case 'storage':
    		{
    			itemsViewport.push(workspace.writepanel.getStorageMenu());
    			itemsViewport.push(workspace.writepanel.getStoragePanel());
    		...
    		case 'studio':
    		{
    			itemsViewport.push(workspace.writepanel.getStudioMenu());
    			itemsViewport.push(workspace.writepanel.getStudioPanel());
...
function resizeSpreadBox(sheetnumber)
{
	...
	$('#functionvalue_' + sheetnumber).width(parentWidth - 201);	
