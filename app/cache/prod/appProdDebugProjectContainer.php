...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'imag_ldap.ldap_manager' => 'getImagLdap_LdapManagerService',
            'imag_ldap.security.authentication.provider' => 'getImagLdap_Security_Authentication_ProviderService',
            'imag_ldap.security.authentication.provider.main' => 'getImagLdap_Security_Authentication_Provider_MainService',
            'imag_ldap.security.user.provider' => 'getImagLdap_Security_User_ProviderService',
            'kernel' => 'getKernelService',
            'kernel.class_cache.cache_warmer' => 'getKernel_ClassCache_CacheWarmerService',
            'koolawa_ajax.storage' => 'getKoolawaAjax_StorageService',
            'koolawa_ajax.user' => 'getKoolawaAjax_UserService',
            'ldap.listener' => 'getLdap_ListenerService',
            ...
            'monolog.logger.ldap_connection' => 'getMonolog_Logger_LdapConnectionService',
            ...
            'security.firewall.map.context.ajax' => 'getSecurity_Firewall_Map_Context_AjaxService',
            ...
            'security.user.provider.concrete.in_database' => 'getSecurity_User_Provider_Concrete_InDatabaseService',
            'security.user.provider.concrete.in_multiples' => 'getSecurity_User_Provider_Concrete_InMultiplesService',
            'security.user_checker.ajax' => 'getSecurity_UserChecker_AjaxService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.main' => 'security.user_checker.ajax',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KoolawaCoreBundle', ($this->targetDirs[2].'/Resources/KoolawaCoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KoolawaCoreBundle', ($this->targetDirs[3].'/src/Koolawa/CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KoolawaAppsBundle', ($this->targetDirs[2].'/Resources/KoolawaAppsBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KoolawaAppsBundle', ($this->targetDirs[3].'/src/Koolawa/AppsBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('ldap.listener', 'Koolawa\\AppsBundle\\EventListener\\LdapSecuritySubscriber');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'koolawa', 'user' => 'root', 'password' => 't0change', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Koolawa/AppsBundle/Entity'))), 'Koolawa\\AppsBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('KoolawaAppsBundle' => 'Koolawa\\AppsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_68a636324810f2411a99530944456cf257bb83da7b4eb473b231ee7d6ad472d4');
    ...
    /**
     * Gets the 'imag_ldap.ldap_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IMAG\LdapBundle\Manager\LdapManagerUser A IMAG\LdapBundle\Manager\LdapManagerUser instance
     */
    protected function getImagLdap_LdapManagerService()
    {
        return $this->services['imag_ldap.ldap_manager'] = new \IMAG\LdapBundle\Manager\LdapManagerUser(new \IMAG\LdapBundle\Manager\LdapConnection(array('client' => array('host' => '20.501.100', 'port' => 389, 'version' => 3, 'username' => 'zpata_synchroglpi@intra.zpata', 'password' => 'St3v3@T2S@', 'network_timeout' => 60, 'referrals_enabled' => false, 'bind_username_before' => false, 'skip_roles' => false), 'user' => array('base_dn' => 'DC=intra,DC=zpata', 'filter' => '(objectClass=user)', 'name_attribute' => 'samAccountName', 'domain' => 'intrazpata', 'attributes' => array()), 'role' => array('base_dn' => 'DC=intra,DC=zpata', 'name_attribute' => 'cn', 'user_attribute' => 'dn', 'user_id' => 'dn'), 'user_class' => 'IMAG\\LdapBundle\\User\\LdapUser'), $this->get('monolog.logger.ldap_connection')));
    }

    /**
     * Gets the 'imag_ldap.security.authentication.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IMAG\LdapBundle\Provider\LdapAuthenticationProvider A IMAG\LdapBundle\Provider\LdapAuthenticationProvider instance
     */
    protected function getImagLdap_Security_Authentication_ProviderService()
    {
        return $this->services['imag_ldap.security.authentication.provider'] = new \IMAG\LdapBundle\Provider\LdapAuthenticationProvider('', '', $this->get('imag_ldap.ldap_manager'), $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), '', true);
    }

    /**
     * Gets the 'imag_ldap.security.authentication.provider.main' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IMAG\LdapBundle\Provider\LdapAuthenticationProvider A IMAG\LdapBundle\Provider\LdapAuthenticationProvider instance
     */
    protected function getImagLdap_Security_Authentication_Provider_MainService()
    {
        $a = $this->get('security.user.provider.concrete.in_multiples');

        return $this->services['imag_ldap.security.authentication.provider.main'] = new \IMAG\LdapBundle\Provider\LdapAuthenticationProvider($a, new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $this->get('security.user_checker.ajax'), 'main', $this->get('security.encoder_factory'), true), $this->get('imag_ldap.ldap_manager'), $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), 'main', true);
    }

    /**
     * Gets the 'imag_ldap.security.user.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IMAG\LdapBundle\Provider\LdapUserProvider A IMAG\LdapBundle\Provider\LdapUserProvider instance
     */
    protected function getImagLdap_Security_User_ProviderService()
    {
        return $this->services['imag_ldap.security.user.provider'] = new \IMAG\LdapBundle\Provider\LdapUserProvider($this->get('imag_ldap.ldap_manager'), false, 'IMAG\\LdapBundle\\User\\LdapUser');
    }
    ...
    /**
     * Gets the 'koolawa_ajax.storage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Koolawa\AjaxBundle\Controller\StorageController A Koolawa\AjaxBundle\Controller\StorageController instance
     */
    protected function getKoolawaAjax_StorageService()
    {
        return $this->services['koolawa_ajax.storage'] = new \Koolawa\AjaxBundle\Controller\StorageController($this);
    }

    /**
     * Gets the 'koolawa_ajax.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Koolawa\AjaxBundle\Controller\UserController A Koolawa\AjaxBundle\Controller\UserController instance
     */
    protected function getKoolawaAjax_UserService()
    {
        return $this->services['koolawa_ajax.user'] = new \Koolawa\AjaxBundle\Controller\UserController($this);
    }

    /**
     * Gets the 'ldap.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Koolawa\AppsBundle\EventListener\LdapSecuritySubscriber A Koolawa\AppsBundle\EventListener\LdapSecuritySubscriber instance
     */
    protected function getLdap_ListenerService()
    {
        return $this->services['ldap.listener'] = new \Koolawa\AppsBundle\EventListener\LdapSecuritySubscriber($this->get('doctrine'));
    }
    ...
    /**
     * Gets the 'monolog.logger.ldap_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bridge\Monolog\Logger A Symfony\Bridge\Monolog\Logger instance
     */
    protected function getMonolog_Logger_LdapConnectionService()
    {
        $this->services['monolog.logger.ldap_connection'] = $instance = new \Symfony\Bridge\Monolog\Logger('ldap_connection');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Koolawa\\AppsBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1)), 'IMAG\\LdapBundle\\User\\LdapUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.ajax' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(ajax|admin/ajax)'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.ajax' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_AjaxService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.ajax'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_database'), 1 => $this->get('imag_ldap.security.user.provider'), 2 => $this->get('security.user.provider.concrete.in_multiples')), 'ajax', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57e8e69a15c455.63170160', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'ajax', NULL, NULL, NULL, $b, false));
    }
    ...
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('security.user.provider.concrete.in_multiples');
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '94e5a849086f97dc6d08694e53ed5ed78b1a44b4', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);
        ...
        $k->setOptions(array('login_path' => '/', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $l->setOptions(array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $m = new \IMAG\LdapBundle\EventListener\LdapListener($this->get('security.context'), $g, $j, $e, 'main', $k, $l, array('check_path' => '/login_check', 'intention' => 'authenticate', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'post_only' => true), $c, $d, $this->get('form.csrf_provider'));
        $m->setRememberMeServices($h);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_database'), 1 => $this->get('imag_ldap.security.user.provider'), 2 => $b), 'app', $c, $d), 2 => $i, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d, true, $j), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57e8e69a15c455.63170160', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/', false), NULL, NULL, $c, false));
    }
    ...
    /**
     * Gets the 'security.user_checker.ajax' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_AjaxService()
    {
        return $this->services['security.user_checker.ajax'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'KoolawaCoreBundle', 1 => 'KoolawaAppsBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/imag/ldap-bundle/IMAG/LdapBundle/Resources/views'), 'IMAGLdap');
        $instance->addPath(($this->targetDirs[3].'/src/Koolawa/AppsBundle/Resources/views'), 'KoolawaApps');
        $instance->addPath(($this->targetDirs[3].'/src/Koolawa/AjaxBundle/Resources/views'), 'KoolawaAjax');
        $instance->addPath(($this->targetDirs[3].'/src/Koolawa/CoreBundle/Resources/views'), 'KoolawaCore');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('94e5a849086f97dc6d08694e53ed5ed78b1a44b4');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57e8e69a15c455.63170160'), 1 => $this->get('imag_ldap.security.authentication.provider.main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($this->get('security.user_checker.ajax'), '94e5a849086f97dc6d08694e53ed5ed78b1a44b4', 'main'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57e8e69a15c455.63170160')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_LDAP' => array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY', 1 => 'ROLE_USER')));
    }

    /**
     * Gets the 'security.user.provider.concrete.in_database' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['security.user.provider.concrete.in_database'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'KoolawaAppsBundle:User', NULL, NULL);
    }

    /**
     * Gets the 'security.user.provider.concrete.in_multiples' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_InMultiplesService()
    {
        return $this->services['security.user.provider.concrete.in_multiples'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.in_database'), 1 => $this->get('imag_ldap.security.user.provider')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IMAGLdapBundle' => 'IMAG\\LdapBundle\\IMAGLdapBundle',
                'KoolawaAppsBundle' => 'Koolawa\\AppsBundle\\KoolawaAppsBundle',
                'KoolawaAjaxBundle' => 'Koolawa\\AjaxBundle\\KoolawaAjaxBundle',
                'KoolawaCoreBundle' => 'Koolawa\\CoreBundle\\KoolawaCoreBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdDebugProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'koolawa',
            'database_user' => 'root',
            'database_password' => 't0change',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '94e5a849086f97dc6d08694e53ed5ed78b1a44b4',
            'locale' => 'en',
            ...
            'kernel.secret' => '94e5a849086f97dc6d08694e53ed5ed78b1a44b4',
            ...
            'imag_ldap.security.user.provider.class' => 'IMAG\\LdapBundle\\Provider\\LdapUserProvider',
            'imag_ldap.ldap_connection.class' => 'IMAG\\LdapBundle\\Manager\\LdapConnection',
            'imag_ldap.ldap_manager.class' => 'IMAG\\LdapBundle\\Manager\\LdapManagerUser',
            'imag_ldap.security.authentication.provider.class' => 'IMAG\\LdapBundle\\Provider\\LdapAuthenticationProvider',
            'imag_ldap.security.authentication.listener.class' => 'IMAG\\LdapBundle\\EventListener\\LdapListener',
            ...
            'imag_ldap.authentication.bind_username_before' => false,
            'imag_ldap.model.user_class' => 'IMAG\\LdapBundle\\User\\LdapUser',
